...
<figure><img src="../../.gitbook/assets/grand_stave_middle_c.svg" alt="Figura 1.7. Exemplo de uma Grande Clave com notas desde C2 até C6 (quatro oitavas)."><figcaption><p>Figura 1.7. Exemplo de uma Grande Clave com notas desde C2 até C6 (quatro oitavas).</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/staff_accidentals.svg" alt="Figura 1.8. As cinco alterações musicais mais frequentes."><figcaption><p>Figura 1.8. As cinco alterações musicais mais frequentes.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/scale_cmajor_degrees.svg" alt="Figura 1.9. Escala de Dó Maior com os respetivos graus. A numeração usada para os graus é independente da escala usada e indica a posição da nota na escala."><figcaption><p>Figura 1.9. Escala de Dó Maior com os respetivos graus. A numeração usada para os graus é independente da escala usada e indica a posição da nota na escala.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/staff_clefs.svg" alt="Figura 1.10. Exemplo de dez claves diferentes. Do lado direito do nome da clave é apresentada, entre parênteses, a nota de referência na respetiva oitava."><figcaption><p>Figura 1.10. Exemplo de dez claves diferentes. Do lado direito do nome da clave é apresentada, entre parênteses, a nota de referência na respetiva oitava.</p></figcaption></figure>
